...
const coaches=[
  ...
  {name:"Jordan Thomas",team:"Universidad México Panteras",role:"Head Coach",image:"assets/coaches/jordan-thomas-umx.png",record:"Inaugural season",scheme:"Power spread",background:"Thomas leads the Panteras from Mexico City as Universidad México becomes the first college outside the United States to enter the NCAA.",storyline:"A new country. A new frontier. College football history starts in Ciudad de México."}
];
